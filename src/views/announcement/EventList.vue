<template>
  <div id="book-list-container">
    <Breadcrumb bread-route="活动列表" />

    <CustomTable
      :default-method="getEventList"
      :search-method="getAnnouncementByLocation"
      class="custom-table"
    >
      <el-table-column prop="bookId" show-overflow-tooltip width="120px" label="书本编号" />
      <el-table-column label="活动图片" align="center">
        <template #default="scope" #reference>
          <el-popover placement="top-start" :width="200" trigger="hover">
            <template #reference>
              <img :src="scope.row.imageSrc" style="height: 50px" />
            </template>
            <img :src="scope.row.imageSrc" style="width: 150px; height: 150px" />
          </el-popover>
        </template>
      </el-table-column>
      <el-table-column prop="value" show-overflow-tooltip label="活动内容" />
...
import { getEventList,getAnnouncementByLocation } from "@/api/Announcement";
