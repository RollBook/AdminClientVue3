<template>
  <div id="book-list-container">
    <Breadcrumb bread-route="书本回收站" />

    <CustomTable
      :default-method="getRecycleAuditBookList"
      :search-method="getRecycleAuditBookByName"
      class="custom-table"
    >
      ...
      <el-table-column fixed="right" label="操作" width="100">
        <template #default="scope" class="but">
          <el-button @click="recycle(scope.row.bookId)" size="small">回收</el-button>
        </template>
      </el-table-column>
    </CustomTable>
  </div>
...
import { getRecycleAuditBookList, getRecycleAuditBookByName,recycleAudit } from "@/api/book";
